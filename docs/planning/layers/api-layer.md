...
- ~~Hosting target~~ — **resolved: EC2 + docker-compose, see [deployment.md](../deployment.md).** This doc's own content still doesn't assume a specific host, per architecture.md §1's instruction not to — that stays true regardless.
